...
public interface SessionService {
    ...
    List<Session> getSessions(@QueryParam("application") String application) throws ServiceException;    
    
    @GET
    @Produces(MediaType.APPLICATION_JSON)    
    SessionDetails getSession(@QueryParam("application") String application, @QueryParam("id") String id) throws ServiceException;
