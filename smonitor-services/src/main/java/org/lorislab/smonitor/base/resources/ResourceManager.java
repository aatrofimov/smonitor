...
package org.lorislab.smonitor.base.resources;
...
import org.lorislab.smonitor.base.resources.model.ResourceList;
...
public class ResourceManager {
    ...
    private static String getKeyString(final Enum<?> key, Locale locale, ClassLoader classLoader) {
        ...
        String value = bundle.getString(keyPrefix + "." + key.name());
        return value;
    }
